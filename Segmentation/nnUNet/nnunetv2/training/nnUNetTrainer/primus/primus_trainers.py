...
#nnUNetv2_train 318 3d_fullres 0 -tr _Primus_M_96_BS1
from dynamic_network_architectures.architectures.primus import (
    Primus, PrimusS, PrimusB, PrimusM, PrimusL, PrimusX
)
...
class _Primus_L_48_BS1(nnUNet_Primus_L_Trainer):
    def __init__(
        ...
        plans["configurations"][configuration]["batch_size"] = 1
        super().__init__(plans, configuration, fold, dataset_json, device)
#nnUNetv2_train 318 3d_fullres 0 -tr _Primus_M_ACDC_BS1
class _Primus_M_ACDC_BS1(nnUNet_Primus_M_Trainer):
    def __init__(self, plans, configuration, fold, dataset_json, device=torch.device("cuda")):
        plans["configurations"][configuration]["patch_size"] = (16, 192, 192)
        plans["configurations"][configuration]["batch_size"] = 1
        super().__init__(plans, configuration, fold, dataset_json, device)
